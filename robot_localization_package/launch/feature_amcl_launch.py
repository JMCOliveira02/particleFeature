...
def generate_launch_description():
    ...
    declare_namespace_cmd = DeclareLaunchArgument(
        'namespace', default_value='X', description='Top-level namespace'
    )
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(localization_dir, 'config', 'amcl_params.yaml'),
